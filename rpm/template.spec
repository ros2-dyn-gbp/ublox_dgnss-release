...
%global pkg_name ublox_nav_sat_fix_hp_node
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-ublox-nav-sat-fix-hp-node
Version:        0.5.2
Release:        2%{?dist}
...
%changelog
* Fri Mar 22 2024 Geoff Sokoll <geoff.s@cmpeng.com.au> - 0.5.2-2
- Autogenerated by Bloom

* Fri Mar 22 2024 Geoff Sokoll <geoff.s@cmpeng.com.au> - 0.5.3-1
- Autogenerated by Bloom
