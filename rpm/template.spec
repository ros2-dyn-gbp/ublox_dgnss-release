...
%global pkg_name ublox_ubx_interfaces
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-ublox-ubx-interfaces
Version:        0.5.2
Release:        2%{?dist}
...
%changelog
* Fri Mar 22 2024 Nick Hortovanyi <nick@aussierobots.com.au> - 0.5.3-1
- Autogenerated by Bloom

* Fri Mar 22 2024 Nick Hortovanyi <nick@aussierobots.com.au> - 0.5.2-2
- Autogenerated by Bloom
